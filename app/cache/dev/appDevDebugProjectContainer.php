...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'security.user.provider.concrete.app_users' => 'getSecurity_User_Provider_Concrete_AppUsersService',
    ...
    /**
     * Gets the 'app.ldap' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Symfony\Component\Ldap\LdapClient A Symfony\Component\Ldap\LdapClient instance.
     */
    protected function getApp_LdapService()
    {
        return $this->services['app.ldap'] = new \Symfony\Component\Ldap\LdapClient('tlssbcloud61');
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_3c04fd03440ed002a5d497844cbf8a743336591840c8ed49c3e04c5979e9e50f');
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Symfony\\Component\\Security\\Core\\User\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'SSHA', 1 => true, 2 => 5000))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $i->createUser(new \Symfony\Component\Security\Core\User\User('admin', 'admin', array(0 => 'ROLE_ADMIN')));

        $j = new \Symfony\Component\Security\Http\HttpUtils($d, $d);

        $k = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $j, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($j, '/platform'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => 'logout'));
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($h, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('security.user.provider.concrete.app_users'), 1 => $i), 'main', $a, $c), 2 => $k, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $j, 'main', $l, $m, array('check_path' => 'login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '576299ac15c535.80564728', $a, $f), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $h, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $j, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $j, 'login', false), NULL, NULL, $a, false));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/OCUserBundle/Resources/views'), 'OCUser');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('c63b32989b18d8dd2154ac9acf29c4f92ea47cae');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('security.user.provider.concrete.app_users'), $this->get('security.user_checker.main'), 'main', $this->get('security.encoder_factory'), true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('576299ac15c535.80564728')), true);
    ...
    /**
     * Gets the 'security.user.provider.concrete.app_users' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     * make it public, otherwise you might end up with broken code.
     *
     * @return \Symfony\Component\Security\Core\User\LdapUserProvider A Symfony\Component\Security\Core\User\LdapUserProvider instance.
     */
    protected function getSecurity_User_Provider_Concrete_AppUsersService()
    {
        return $this->services['security.user.provider.concrete.app_users'] = new \Symfony\Component\Security\Core\User\LdapUserProvider($this->get('app.ldap'), 'ou=people,dc=airfrance,dc=fr', 'cn=proxyagent,ou=profile,dc=airfrance,dc=fr', 'M3gf7f5q', array(0 => 'ROLE_USER'), 'sAMAccountName', 'uid={username}');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => 'c63b32989b18d8dd2154ac9acf29c4f92ea47cae',
            'locale' => 'en',
            ...
            'kernel.secret' => 'c63b32989b18d8dd2154ac9acf29c4f92ea47cae',
